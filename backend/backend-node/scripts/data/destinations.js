/** Port of database/seeders/DestinationSeeder.php */
export const destinations = [
  {
    ...
    featuredCountries: ["Bali", "Thailand", "Japan", "Bhutan", "India", "Dubai"],
  },
  {
    name: "Europe",
    slug: "europe",
    ...
    featuredCountries: ["France", "Italy", "Switzerland", "Greece", "Spain", "Netherlands"],
  },
  {
    name: "Africa",
    slug: "africa",
    ...
    featuredCountries: ["Kenya", "Tanzania", "South Africa", "Egypt", "Morocco", "Zanzibar"],
  },
  {
    name: "Oceania",
    slug: "oceania",
    ...
    featuredCountries: ["Australia", "New Zealand", "Fiji", "Maldives"],
  },
  {
    name: "Latin America",
    slug: "latin-america",
    ...
    featuredCountries: ["Peru", "Brazil", "Argentina", "Colombia", "Costa Rica", "Cuba"],
  },
  {
    name: "North America",
    slug: "north-america",
    ...
    featuredCountries: ["USA", "Canada", "Mexico", "Caribbean"],
  },
]
